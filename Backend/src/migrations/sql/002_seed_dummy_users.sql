...
-- ── Insert Users ──────────────────────────────────────
INSERT INTO users (id, email, profile_image, first_name, last_name, title, offer_description, location, about_me, hourly_rate, rating, review_count, verified, category, available_today)
VALUES
  (gen_random_uuid(), 'sarah.dev@example.com', 'https://randomuser.me/api/portraits/women/68.jpg', 'Sarah', 'Johnson', 'Professional House Cleaner', 'Deep cleaning, regular cleaning, and move-in/move-out services', 'Achrafieh, Beirut', 'Professional cleaner with 5 years of experience. I take pride in making homes spotless and organized.', 25.00, 0, 0, true, 'House Cleaning', true)
RETURNING id INTO u1;

INSERT INTO users (id, email, profile_image, first_name, last_name, title, offer_description, location, about_me, hourly_rate, rating, review_count, verified, category, available_today)
VALUES
  (gen_random_uuid(), 'mike.butler@example.com', 'https://randomuser.me/api/portraits/men/32.jpg', 'Mike', 'Chen', 'Expert Butler', 'Premium household management and butler services', 'Jounieh', 'Trained butler with experience serving high-profile households. I ensure your home runs like clockwork.', 55.00, 0, 0, true, 'Butler Services', true)
RETURNING id INTO u2;

INSERT INTO users (id, email, profile_image, first_name, last_name, title, offer_description, location, about_me, hourly_rate, rating, review_count, verified, category, available_today)
VALUES
  (gen_random_uuid(), 'lina.photo@example.com', 'https://randomuser.me/api/portraits/women/44.jpg', 'Lina', 'Khoury', 'Professional Photographer', 'Capturing moments that tell your story', 'Tripoli', 'Professional photographer specializing in portraits, events, and commercial photography. Over 8 years of experience.', 60.00, 0, 0, true, 'Photography', false)
RETURNING id INTO u3;

INSERT INTO users (id, email, profile_image, first_name, last_name, title, offer_description, location, about_me, hourly_rate, rating, review_count, verified, category, available_today)
VALUES
  (gen_random_uuid(), 'omar.tutor@example.com', 'https://randomuser.me/api/portraits/men/46.jpg', 'Omar', 'Hassan', 'Math & Science Tutor', 'Making learning fun and accessible for all ages', 'Zahle', 'Certified tutor with 6 years of experience in mathematics and science. I help students build confidence and achieve top grades.', 30.00, 0, 0, false, 'Tutoring', true)
RETURNING id INTO u4;

INSERT INTO users (id, email, profile_image, first_name, last_name, title, offer_description, location, about_me, hourly_rate, rating, review_count, verified, category, available_today)
VALUES
  (gen_random_uuid(), 'nadia.events@example.com', 'https://randomuser.me/api/portraits/women/90.jpg', 'Nadia', 'Farah', 'Event Planning Expert', 'Creating unforgettable events from concept to execution', 'Hamra, Beirut', 'Event planner with expertise in weddings, corporate events, and private parties. Helped plan 100+ successful events.', 40.00, 0, 0, true, 'Event Planning', true)
RETURNING id INTO u5;

INSERT INTO users (id, email, profile_image, first_name, last_name, title, offer_description, location, about_me, hourly_rate, rating, review_count, verified, category, available_today)
VALUES
  (gen_random_uuid(), 'ali.driver@example.com', 'https://randomuser.me/api/portraits/men/62.jpg', 'Ali', 'Mansour', 'Professional Chauffeur', 'Safe and reliable private driving services', 'Baabda', 'Licensed chauffeur with 10 years of experience. I provide safe, punctual, and comfortable transportation.', 35.00, 0, 0, true, 'Chauffeur & Drivers', false)
RETURNING id INTO u6;

INSERT INTO users (id, email, profile_image, first_name, last_name, title, offer_description, location, about_me, hourly_rate, rating, review_count, verified, category, available_today)
VALUES
  (gen_random_uuid(), 'raya.nanny@example.com', 'https://randomuser.me/api/portraits/women/33.jpg', 'Raya', 'Abdel', 'Childcare Specialist', 'Loving and professional childcare and nanny services', 'Saida (Sidon)', 'Certified childcare provider with first aid training. I create a safe, fun, and nurturing environment for your children.', 20.00, 0, 0, true, 'Childcare & Nanny', true)
RETURNING id INTO u7;

INSERT INTO users (id, email, profile_image, first_name, last_name, title, offer_description, location, about_me, hourly_rate, rating, review_count, verified, category, available_today)
VALUES
  (gen_random_uuid(), 'karim.fitness@example.com', 'https://randomuser.me/api/portraits/men/84.jpg', 'Karim', 'Nasser', 'Personal Fitness Trainer', 'Transform your body and mind with personalized training', 'Verdun, Beirut', 'Certified personal trainer specializing in strength training, HIIT, and nutrition planning. Helping clients reach their goals for 7 years.', 45.00, 0, 0, false, 'Personal Training', true)
RETURNING id INTO u8;

INSERT INTO users (id, email, profile_image, first_name, last_name, title, offer_description, location, about_me, hourly_rate, rating, review_count, verified, category, available_today)
VALUES
  (gen_random_uuid(), 'john@gmail.com', 'https://randomuser.me/api/portraits/men/22.jpg', 'John', 'Doe', 'Expert Handyman', 'Reliable home repairs and maintenance', 'Ashrafieh, Beirut', 'Jack of all trades with 15 years experience fixing everything around the house. Fast and reliable service.', 30.00, 0, 0, true, 'Handyman', true)
RETURNING id INTO u9;

INSERT INTO users (id, email, profile_image, first_name, last_name, title, offer_description, location, about_me, hourly_rate, rating, review_count, verified, category, available_today)
VALUES
  (gen_random_uuid(), 'emma.chef@example.com', 'https://randomuser.me/api/portraits/women/24.jpg', 'Emma', 'Smith', 'Personal Chef', 'Custom meals tailored to your dietary needs', 'Downtown Beirut', 'Culinary arts graduate specializing in organic and healthy meal preparations for individuals and families.', 50.00, 0, 0, true, 'Cooking & Baking', false)
RETURNING id INTO u10;

INSERT INTO users (id, email, profile_image, first_name, last_name, title, offer_description, location, about_me, hourly_rate, rating, review_count, verified, category, available_today)
VALUES
  (gen_random_uuid(), 'david.garden@example.com', 'https://randomuser.me/api/portraits/men/11.jpg', 'David', 'Brown', 'Landscape Designer', 'Beautiful gardens and outdoor spaces', 'Byblos', 'Passionate gardener that brings life to your backyard. Specialized in sustainable native plants.', 35.00, 0, 0, false, 'Gardening', true)
RETURNING id INTO u11;

INSERT INTO users (id, email, profile_image, first_name, last_name, title, offer_description, location, about_me, hourly_rate, rating, review_count, verified, category, available_today)
VALUES
  (gen_random_uuid(), 'sofia.pets@example.com', 'https://randomuser.me/api/portraits/women/12.jpg', 'Sofia', 'Garcia', 'Professional Pet Sitter', 'Loving care for your furry friends', 'Sin El Fil', 'Lifelong animal lover providing dog walking, pet sitting, and basic grooming services.', 15.00, 0, 0, true, 'Pet Care', true)
